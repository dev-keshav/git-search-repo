...
const Navbar = ({setUserData}) => {
  ...
  return (
    <Flex justifyContent={'space-between'} py={6} alignItems={"Center"} borderBottomWidth={2} borderColor='#2EA043'
      backgroundColor='#000' zIndex={10} position='fixed' top={0} width='container.lg' >
        <box>
